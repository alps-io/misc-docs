...
<alps>
  ...
  <descriptor id="search" type="safe"> <2>
    <descriptor id="text" type="semantic"> <3>
  </descriptor>
</alps>
...
<html>
  <head>
    <link rel="profile" href="http://alps.io/profiles/search" /> <4>
  </head>
  <body>
    <form action="..." method="get">
      <input type="text" name="q" class="text" value="" /> <5>
      <input type="submit" class="search" /> <6>
    </form>
  </body>
</html>
----
...
<alps>
  ...
  <descriptor id="update-form" type="idempotent" /> <10>
  <descriptor id="remove-link" type="safe" /> <11>
  <descriptor id="remove-form" type="idempotent" /> <12>
...
The following HTML4 representation is an example of what might be returned when a client application activates the +login-link+:
      
.HTML4 Representation for creating a new user account.
----
<html>
  ...
  <body>
    ...
    <form action="..." method="post">
      ...
      <input type="submit" value="Save" class="create" /> <8>
    </form>
  </body>
</html>
----
...
.HTML4 Representation for updating an existing user account.
----
<html>
  <head profile="http://alps.io/profiles/useraccount"> <1>
